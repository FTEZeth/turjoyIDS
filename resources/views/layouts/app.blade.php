...
<body>
    ...
    <nav class="border-gray-200 bg-blue-500 dark:bg-gray-800 dark:border-gray-700" style="background-color: #0A74DA; color: white;">
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
        ...
        @guest
          <li>
            <a href="{{ route('auth.login') }}" class="block py-2 pl-3 pr-4 text-white hover:text-gray-200 rounded hover:bg-#333333 bg-#f4f4f4 md:border-0 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Iniciar Sesión</a>
          </li>
        @endguest
        </ul>
      </div>
