...
@else
    ...
    <div class="flex flex-col flex-1 justify-center items-center my-6">
        <div class="mb-12 mx-auto">
            <a class="px-6 py-3 bg-red-500 hover:bg-red-400 transition-all text-gray-200 font-semibold rounded-lg"
        ...
        <form class ="flex flex-col items-center w-1/2" action = "{{route('routes.check')}}" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                @error('document')
                    <p class="bg-red-500 font-semibold my-4 text-lg text-center text-gray-200 px-4 py-3 rounded-lg">
                        {{$message}}
                    </p>
                @enderror
            </div>

            <button class="lg:w-1/4 my-4 p-2 bg-green-400 rounded-sm text-gray-200 font-semibold" type="submit">
                Importar rutas
            </button>
        </form>
    </div>
