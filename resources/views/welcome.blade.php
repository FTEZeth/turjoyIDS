        ...
        <form id="form" name="form" action="{{ route('reservationStore') }}" method="POST">
            ...
            <div class="flex items-center space-x-4 w-full">
                ...
                <div class="flex items-center space-x-2 flex-1">
                    ...
                    <select id="origins" name="origins" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
                ...
                <div class="flex items-center space-x-2 flex-1">
                    ...
                    <select id="destinations" name="destinations" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
                ...
                <div class="flex items-center space-x-2 flex-1">
                    ...
                    <input type="date" id="date" name="date" min="{{ date('Y-m-d', strtotime('+0 day'))}}" max="2023-12-31" class="block w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
                </div>

                <!-- Dropdown for Seats -->
                <div class="flex items-center space-x-2 flex-1">
                    <img src="images/asiento.png" alt="Seat icon" class="w-6 h-6 self-center">
                    <select id="seats" name="seats" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
