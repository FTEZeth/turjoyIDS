        ...
        <form id="form" name="form" action="{{ route('reservationStore') }}" method="GET">
            ...
            <div class="flex items-center space-x-4 w-full">
                ...
                <div class="flex items-center space-x-2 flex-1">
                    ...
                    <input type="date" id="date" name="date" min="2023-01-01" max="2023-12-31" class="block w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
                </div>
