...
Route::middleware(['auth'])->group(function () {
    ...
    })->name('menu'); //Vista de menú de administrador
    ...
    Route::get('/search-reservation', [ReservationController::class, 'searchToDate'])->name('searchToDate'); //Botón de buscar reserva
});
